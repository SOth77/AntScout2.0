...
object Settings {
   ...
   */
  val PathOutput = getInt("ant-scout.frequencyOutput")

  /**
   *Maximale Anzahl an Ausgaben
   */
  val MaxOutput = getInt("ant-scout.maxOutput")
  
  /**
   * Aktuelle Anzahl an Ausgaben
   */
  var ActOutput = 1
